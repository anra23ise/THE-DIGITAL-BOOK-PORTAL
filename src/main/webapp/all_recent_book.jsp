                            ...
                            <% User u=(User) session.getAttribute("userobj"); %>
                                <%@include file="all_component/navbar.jsp" %>
                                    <div class="container-fluid">
                                        ...
                                        <c:if test="${not empty wishmessage }">
                                            <h5 class="text-center text-success">${wishmessage }</h5>
                                            <c:remove var="wishmessage" scope="session" />
                                        </c:if>

                                        <div class="row p-3">
                                            <% BookDAOImpl dao2=new BookDAOImpl(DBConnect.getConn()); List<BookDtls>
                                                list2 = dao2.getAllRecentBook();
                                                        ...
                                                        <div class="card-body text-center">
                                                            ...
                                                            <div class="row">
                                                                <a href="view_books.jsp?bid=<%=b.getBookId()%>"
                                                                    class="btn btn-success btn-sm ml-5">View
                                                                    Details2</a> <a href=""
