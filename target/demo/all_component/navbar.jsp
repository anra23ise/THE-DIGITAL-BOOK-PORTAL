		...
		<%@page import="com.entity.Category" %>
			<%@page import="java.util.List" %>
								...
								<div class="container-fluid p-3 bg-light">
									<div class="row">
										<div class="col-md-3 text-success">
											<h3>
												<i class="fas fa-book"></i> Digital Books
											</h3>
										</div>
										...
										<c:if test="${not empty userobj}">
											<div class="col-md-5">
												<div class="row">
													<% User us=(User) session.getAttribute("userobj"); CartDAOImpl
														daoy=new CartDAOImpl(DBConnect.getConn()); int
														i=daoy.countCart(us.getId()); %>
														<div class="col-md-4 text-right pt-1 pr-0 ">
															<span style="font-size: 24px;">(<%=i%>)
															</span><a href="checkout.jsp"><i
				...
				href="all_recent_book.jsp"><i class="fas fa-book-open"></i>
					Recent Book</a></li> -->
											<li class="nav-item">
												<a class="nav-link" href="wishlist.jsp"><i class="fas fa-heart"></i> My
													Wishlist</a>
											</li>
												...
												<div class="dropdown-menu" aria-labelledby="navbarDropdown">
													...
													<% BookDAOImpl daox=new BookDAOImpl(DBConnect.getConn());
														...
														<a class="dropdown-item"
															href="catogory_book.jsp?ca=<%=c.getCategoryName()%>">
															<%=c.getCategoryName()%>
														</a>
														<% } %>
				...
				href="all_old_book.jsp"><i class="fas fa-book-open"></i> Old
					Book</a></li> -->
										...
										<form class="form-inline my-2 my-lg-0">
											<a href="setting.jsp" class="btn btn-light my-2 my-sm-0" type="submit"> <i
